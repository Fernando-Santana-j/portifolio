...
var textLangs = {
    'en-US':{
        ...
        work:{
            ...
            "sdkapps-descricao":"I'm presenting sdkapps, a platform where we offer Discord sellers a bot and a dashboard to manage their sales, create products and sell them in the most modern, advanced and fastest way on the market! This project was developed by me, from the website to the integrated Discord bot. To learn more, click the deploy button and see the official website!"
        },
        curriculo:{
    ...
    'pt-BR':{
        ...
        work:{
            ...
            "sdkapps-descricao":"Estou apresentando o sdkapps uma plataforma onde oferecemos aos vendedores do Discord um bot e um dashboard para gerenciar suas vendas, criar produtos e vendê-los da maneira mais moderna, avançada e rápida do mercado! Esse projeto foi desenvolvido por mim, desde o site até o bot integrado do Discord. Para saber mais, clique no botão de deploy e veja o site oficial!"
        },
        curriculo:{
